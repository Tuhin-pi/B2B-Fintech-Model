...
def predict(nulldata):
    ...
    nulldata["buisness_year"]=pd.to_datetime(nulldata.buisness_year)
    nulldata["buisness_year"]=nulldata["buisness_year"].dt.year
...
def doc_id_bucket(doc_list):
   ...
   # if :
    ...
    labels = ['Paid before clear date','0-15','16-30','31-45','46-60','Greatar than 60']
    Final['Aging Bucket'] = pd.cut(Final['avg_delay'], bins=bins, labels=labels, right=False)
